...
모든 답변 끝에 **다음 할 일**을 적는다.

- **바로 다음에 할 것** — 이번 작업에 이어지는 한 가지
- **남은 작업** — 미해결 항목을 등급/단계와 함께. 특히 **미해결 P0가 있으면 반드시 명시**한다
- 사용자가 결정해야 할 선택지가 있으면 추천안을 함께 제시한다

완료 보고에 묻혀서 미해결 항목이 안 보이는 일이 없도록 한다.
